...
public class PKCSPaddingUtil {
	...
	public static byte[] PKCS7Padding(byte[] content, int blockSize) throws Exception{
	...
	public static byte[] PKCS7Unpadding(byte[] content, int blockSize) throws Exception{
